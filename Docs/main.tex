...
% Oprócz tych podstawowych zasad obiektowych \Csharp ułatwia tworzenie komponentów oprogramowania za pomocą kilku innowacyjnych konstrukcji językowych, w tym:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
    ...
    % Warto zaznaczyc ze presentaion layer to w backend WebApi, fronend to osobny projekt oparty o architekutre 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
    ...
    % Został on zaprojektowany w roku 1979 przez norweskiego programistę Trygve Reenskaug pracującego wtedy nad językiem Smalltalk w laboratoriach Xerox - WIKIPEDIA
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
    ...
    % \textcolor{red}{Wszystko zostało po krótce opisane w rozdziale \ref{EF} dlatego nie wiem czy jest sens powielać ten opis tutaj}
